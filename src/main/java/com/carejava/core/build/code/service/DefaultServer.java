...
public class DefaultServer implements IBuild {
    ...
    public static void setResourceLoader(ClasspathResourceLoader resourceLoader) {
        DefaultServer.resourceLoader = resourceLoader;
    }
    ...
    private static void initStatic(String rootPath, Project project) {
    ...
    private static void initWeb(String rootPath, Project project) {
    ...
    private static void initPom(String rootPath, Project project) {
        Util.createFolders(rootPath);
        // 创建application.xml
    ...
    private static void initResource(String rootPath, Project project) {
    ...
    public static void initServer(String rootPath, Project project) {
        String srcBasePath = rootPath + "/" + project.getPkgName().replace(".", "/");
    ...
    public static void initMapper(String rootPath, Project project) {
